package org.mavydragons.buttermc.CustomMaps.data;

import org.mavydragons.buttermc.Main;
import org.mavydragons.buttermc.CustomMaps.models.LogoRenderer;
...
public class ImageManager implements Listener {
    ...
    private CustomFile dataFile = new CustomFile("settings.yml");
